...
void setup() {
  ...
  Serial.print("Connecting to WiFi MI-9 ");
  ...
  if (WL_CONNECTED==false){
      setTime(03, 59, 40, 30, 3, 2025);  // 2h matinada 30 març, es hivern i que que restar 1 hora
      Serial.println("No conectat");
    }else{
...
*/
  ...
  tft.pushImage(150, 0, 60, 41, logo_TRANSPARENTE);
  delay(2000);
  */
  //////////////////////////////////////////////////Grids();
}
...
void loop(void) {
 ...
 ///////////////////// tft.drawString("C.I. TARRAGONA", 10, 10, 8);  // Draw the text string in the selected GFX free font

  tft.setCursor(1, 1);
  tft.setTextFont(2u);
  tft.setTextSize(1);
  //tft.drawNumber(i, 50, 50, 7);
  tft.print("C.I. TARRAGONA"); //, 20, 20, 7);
  tft.print(tm);
...
void Date_hora(){
  ...
  tft.pushImage(1, 170, 60, 41, logo_TRANSPARENTE);
