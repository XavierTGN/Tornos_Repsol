...
// Spain Time Zone
TimeChangeRule esEstiu = {"CEST", First, Sun, Apr, 2, 120};   // UTC + 2 hours
TimeChangeRule esHivern = {"CET", Last, Sun, Oct, 3, 60};    // UTC + 1 hours
...
void setup()
{
    ...
    // Spain
    printTimes( 1,  4, 2025, esEstiu.hour, esHivern.offset, cet); // day, month, year, hour, offset, tz
    printTimes(30,  9, 2025, esEstiu.hour, esHivern.offset, cet);
    printTimes( 7,  4, 2026, esEstiu.hour, esHivern.offset, cet);
    printTimes( 30,  9, 2026, esEstiu.hour, esHivern.offset, cet);
