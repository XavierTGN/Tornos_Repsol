...
// TORNO 1
#define DIRECCION_ESCLAVO_30 30
#define DIRECCION_ESCLAVO_31 31
...
void loop() {
  ...
  if( resultadoUpdate == false ){
    ...
    enviarMensajeEsclavo(DIRECCION_ESCLAVO_30, horaActEnv, minutosActEnv, segundosActEnv, diaActEnv, mesActEnv, anoActEnv);
    enviarMensajeEsclavo(DIRECCION_ESCLAVO_31, horaActEnv, minutosActEnv, segundosActEnv, diaActEnv, mesActEnv, anoActEnv);
