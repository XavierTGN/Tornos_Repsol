...
void parteSuperiorTFT(){
  // IMPRIMIR SEPARADORES VERTICALES, GUÍAS
  tft.drawLine(15, 0, 15, 320, ILI9341_BLUE);
  tft.drawLine(305, 0, 305, 320, ILI9341_BLUE);

  // IMPRIMIR FECHA
  tft.setFont(&FreeMono9pt7b);
  tft.setTextColor(ILI9341_BLACK);
  tft.setCursor(110, 13);
  ...
  tft.printf("CONTROL ACCESOS");*/

  // IMPRIMIR "C.I. TARRAGONA"
  tft.setFont(&FreeMono9pt7b);
  tft.setTextColor(ILI9341_BLACK);
  tft.setCursor(75, 50); // X= 16 Y= 237
...
void parteInferiorTFT(){
  ...
  // IMPRIMIR SEPARADORES NARANJAS
  tft.drawLine(0, 223, 320, 223, ILI9341_ORANGE);
  tft.drawLine(0, 224, 320, 224, ILI9341_ORANGE);
...
void mostrarLogoRepsol(){
  tft.drawRGBBitmap(100, 140, repsolBitMap, 110, 80);
}
